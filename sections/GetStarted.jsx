    ...
    >
      ...
      >
        <img
          ...
          alt="get-started"
          className="w-[80%] h-[80%] object-contain rounded-sm shadow-md"
        />
      </motion.div>
      <motion.div
      ...
      >
        ...
        <p className="mt-[8px] font-normal sm:text-[20px] text-[16px] text-left text-secondary-white">
          Our lab is led by Dr. Avinash Eranki, Assistant Professor within the
          Department of Biomedical Engineering at Indian Institute of
          ...
          tumors. His recent work on therapeutic ultrasound and immunotherapy is
